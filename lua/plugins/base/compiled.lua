...
_G.packer_plugins = {
  ...
  ["material.nvim"] = {
    ...
    loaded = true,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/start/material.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-tabnine", "luasnip", "cmp-nvim-lua", "cmp-cmdline" },
...
require 'plugins.ui.theme.material'
