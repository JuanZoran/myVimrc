...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "cmp-buffer", "cmp-path", "luasnip" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'SmoothCursor.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
