...
_G.packer_plugins = {
  ...
  Trans = {
    config = { "\27LJ\2\n¬\2\0\0\6\0\r\0\0256\0\0\0009\0\1\0009\0\2\0'\2\3\0'\3\4\0'\4\5\0005\5\6\0B\0\5\0016\0\0\0009\0\1\0009\0\2\0'\2\a\0'\3\4\0'\4\b\0005\5\t\0B\0\5\0016\0\0\0009\0\1\0009\0\2\0'\2\a\0'\3\n\0'\4\v\0005\5\f\0B\0\5\1K\0\1\0\1\0\1\tdesc\29ïž¾ Translate From Input <Cmd>TranslateInputWord<CR>\ami\1\0\1\tdesc\18ïž¾ Translate!<Cmd>TranslateCursorWord<CR>\6n\1\0\1\tdesc\18ïž¾ Translate&<Esc><Cmd>TranslateSelectWord<CR>\amm\6v\bset\vkeymap\bvim\0" },
    keys = { { "v", "mm" }, { "n", "mm" }, { "n", "mi" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-nvim-lua", "cmp-path", "cmp-cmdline", "luasnip", "cmp-rg" },
  ...
  ["telescope-emoji.nvim"] = {
    config = { "\27LJ\2\n¸\1\0\0\6\0\v\0\0156\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\0016\0\4\0009\0\5\0009\0\6\0'\2\a\0'\3\b\0'\4\t\0005\5\n\0B\0\5\1K\0\1\0\1\0\1\tdesc\21ðŸ¤ Search Emoji\29<cmd>Telescope emoji<cr>\15<leader>tm\6n\bset\vkeymap\bvim\nemoji\19load_extension\14telescope\frequire\0" },
    keys = { { "", "n" }, { "", "<leader>tm" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/opt/telescope-emoji.nvim",
...
vim.cmd [[noremap <silent> n <cmd>lua require("packer.load")({'telescope-emoji.nvim'}, { keys = "n", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> <leader>tm <cmd>lua require("packer.load")({'telescope-emoji.nvim'}, { keys = "<lt>leader>tm", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'SmoothCursor.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
