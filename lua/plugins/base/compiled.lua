...
_G.packer_plugins = {
  ...
  Trans = {
    config = { "\27LJ\2\nô\1\0\0\6\0\14\0\0226\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\3\0009\0\4\0009\0\5\0005\2\6\0'\3\a\0'\4\b\0005\5\t\0B\0\5\0016\0\3\0009\0\4\0009\0\5\0'\2\n\0'\3\v\0'\4\f\0005\5\r\0B\0\5\1K\0\1\0\1\0\1\tdesc\29ïž¾ Translate From Input\28<Cmd>TranslateInput<CR>\ami\6n\1\0\1\tdesc\18ïž¾ Translate\23<Cmd>Translate<CR>\amm\1\3\0\0\6x\6n\bset\vkeymap\bvim\nsetup\nTrans\frequire\0" },
    keys = { { "x", "mm" }, { "n", "mm" }, { "n", "mi" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  catppuccin = {
    config = { "require 'plugins.ui.theme.catp'" },
    loaded = true,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["clangd_extensions.nvim"] = {
    loaded = true,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/start/clangd_extensions.nvim",
  ...
  ["dracula.nvim"] = {
    config = { "require 'plugins.ui.theme.dracula'" },
    loaded = false,
    needs_bufread = false,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/opt/dracula.nvim",
  ...
  ["kanagawa.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/opt/kanagawa.nvim",
  ...
  ["nordic.nvim"] = {
    config = { "require 'plugins.ui.theme.nordic'" },
    loaded = false,
    needs_bufread = false,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/opt/nordic.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-cmdline", "luasnip" },
    config = { 'require "plugins.lang.cmp"' },
    loaded = true,
    only_config = true,
    path = "/home/zoran/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["telescope-symbols.nvim"] = {
    config = { "\27LJ\2\n}\0\0\6\0\a\0\t6\0\0\0009\0\1\0009\0\2\0'\2\3\0'\3\4\0'\4\5\0005\5\6\0B\0\5\1K\0\1\0\1\0\1\tdesc\23ðŸ¤ Search Symbols\31<cmd>Telescope symbols<cr>\15<leader>tm\6n\bset\vkeymap\bvim\0" },
    keys = { { "", "n" }, { "", "<leader>tm" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
